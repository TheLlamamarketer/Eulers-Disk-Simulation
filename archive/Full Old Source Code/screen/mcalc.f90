...
!
         ...
         do
            ndig = ndig + 1
            val = 10*val + (ichar(ch) - ichar('0'))
            call getch
            if (index(digit,ch) == 0) exit
         enddo
!         
